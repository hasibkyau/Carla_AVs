...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            spawn_point = spawn_points[4] if spawn_points else carla.Transform()
            self.player = self.world.try_spawn_actor(blueprint, spawn_point)
        # Set up the sensors.
...
class CameraManager(object):
    def __init__(self, parent_actor, hud):
        ...
        for item in self.sensors:
            ...
            if item[0].startswith('sensor.camera'):
                ...
                bp.set_attribute('image_size_x', str(640))
                bp.set_attribute('image_size_y', str(480))
    ...
    def _parse_image(weak_self, image):
        ...
        if self.recording:
            ...
            image.save_to_disk('_IMG/%08d' % image.frame_number)


            LIST[0] = str(image.frame_number)
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            LIST[:] = [0.0, c.throttle, c.steer, c.brake, c.gear]
